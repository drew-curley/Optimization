...
INPUT_FILE_A = os.path.expanduser("~/Desktop/Code/mcmc_artifical_data_main.csv")
INPUT_FILE_B = os.path.expanduser("~/Desktop/Code/calculated_capacity_scores.csv")
OUTPUT_FILE = os.path.expanduser("~/Desktop/Code/top_50_donors.csv")
TRACE_FILE = os.path.expanduser("~/Desktop/Code/donor_trace.nc")
PLOT_FILE_COEFFICIENTS = os.path.expanduser("~/Desktop/Code/coefficient_plot.png")
PLOT_FILE_TOP_DONORS = os.path.expanduser("~/Desktop/Code/top_donors_plot.png")
PLOT_FILE_DIAGNOSTICS = os.path.expanduser("~/Desktop/Code/mcmc_diagnostics.png")
